...
namespace DAL
{
    public class DBAccess
    {
        ...
        public static string strProvider = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=planning_nhom04;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
